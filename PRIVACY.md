...
The plugin never requires a user to paste passwords, API keys, recovery codes, or other authentication secrets into chat. Where authentication is needed, it directs the host to use an available authorization or connector flow.

Questions or privacy concerns can be submitted at <https://github.com/wayjan/workfromphone/issues>.
